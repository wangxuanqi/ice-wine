...
<title>后台系统管理</title>
	<script>
		...
		function returnLastPage(table){
			window.location.href = "printData.php?table=storehouse";
		}
	</script>
</head>
	<style>
...
<body>
	<?php
		...
		echo "<a href='printData.php?table=storehouse'><span class='righticon'><font class='fontstyle'>$tip1</font></span></a>";
		...
		echo 	"<table class='tableStyle1' >
					<tr>
						<td align='center' class='titleStyle'>请填写添加的冰酒信息</td>
					</tr>
				</table>
		...
		while ($row = mysqli_fetch_row($columeResult2)) { //获取所有的字段名
			...
			//echo "$colume[$numOfColume]";
				...
				echo	"<table class='tableStyle2'>
						<tr>
							<div class = 'div2' >
								<td width='40%'  class='columeStyle' font>$colume2[$numOfColume]</td>
