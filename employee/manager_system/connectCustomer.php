...
//			$c_tel = "15883838383";    // 电话
		...
		private function all_contents() {
			...
			echo "</div>";
			echo "<script>
  				document.getElementById('display-contents').scrollTop=document.getElementById('display-contents').scrollHeight;
  			</script>";
...
//				"还有B");
		...
		private function input_text() {
			echo
			"<div id='input-text'>".
				"<form action='saveSend.php?c_id=$this->c_id&flag=connect' method='post'>".
